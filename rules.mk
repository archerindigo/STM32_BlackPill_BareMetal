...
GENERATED_BINS  = $(addprefix $(BUILD_DIR)/$(PROJECT), .elf .bin .map .list .lss)
...
all: $(BUILD_DIR)/$(PROJECT).elf $(BUILD_DIR)/$(PROJECT).bin $(BUILD_DIR)/$(PROJECT).lss $(BUILD_DIR)/$(PROJECT).list
flash: $(PROJECT).flash
